...
# -----------------------------------------------------------------------------
# ZoneComponent
# Owned by any node. Centers itself on its parent automatically.
# Two concentric zones. Fires signals when bodies enter or exit.
...
# -----------------------------------------------------------------------------
# setup — called by parent in _ready, builds zones around own origin
# -----------------------------------------------------------------------------
func setup() -> void:
